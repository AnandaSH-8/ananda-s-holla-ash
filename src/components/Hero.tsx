      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center relative z-10">
        ...
        <div className="text-center lg:text-left animate-hero-content-entrance order-2 lg:order-1">
          <div className="relative group mb-8 transition-all duration-500">
            ...
            <h1 className="text-5xl md:text-4xl lg:text-7xl xl:text-8xl font-black text-[#333] dark:text-[#EDEDED] mb-6 leading-tight relative z-10 transition-all duration-500 p-6">
