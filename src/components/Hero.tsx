...
const Hero = () => {
  ...
  return (
    <section
      id="hero"
      className="min-h-screen flex items-center justify-center px-4 pt-20 bg-gradient-to-br from-white/70 via-blue-50/60 to-cyan-50/60 dark:from-[#1A1A2E]/70 dark:via-[#2E2E2E]/60 dark:to-[#1A1A2E]/70 backdrop-blur-sm relative overflow-hidden"
    >
