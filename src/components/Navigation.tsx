...
const Navigation = () => {
  ...
  const pillTransition = reduceMotion ? { duration: 0 } : { type: "spring" as const, stiffness: 400, damping: 32 };
          ...
          {navItems.map((item) => {
            ...
            return (
              <motion.button
                ...
                className={`relative rounded-full px-4 py-1.5 text-base font-medium transition-colors duration-300 ${
