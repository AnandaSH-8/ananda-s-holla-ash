      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground leading-relaxed mb-4">
            ...
            solving real-world problems through clean, maintainable software — across both frontend
            and backend.
          </p>
        ...
        <motion.div {...reveal(0.08)} className="mt-14">
          ...
          <ul className="grid sm:grid-cols-2 gap-x-12">
            {focusAreas.map((item, i) => (
              ...
              >
                <span className="font-display text-sm text-blue-600 dark:text-orange-400 tabular-nums">
                  0{i + 1}
                </span>
        ...
        <motion.div
          {...reveal(0.16)}
          className="mt-14 flex flex-col sm:flex-row sm:items-center gap-8 sm:gap-12"
        >
          ...
          <p className="text-muted-foreground leading-relaxed max-w-xl">
            Hands-on full-stack development, from API design to production delivery. I thrive where
            design and engineering speak the same language — leading through code, clarity, and
            constant iteration, solo or in a team.
          </p>
        </motion.div>
      </div>
    </section>
